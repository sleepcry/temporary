...
public class Wolf extends GamePlayer {
	public static final int BASE = 3;

	float updateCnt = 0;

	private Wolf(float x, float y, float width, float height,
	...
	public static final class Builder {
		...
		public Wolf getWolf() {
			return new Wolf(x, y, width, height, charAttr);
		}
	...
	public float getAttackFactor(GamePlayer attacker) {
		...
		if(attacker instanceof Hunter) {
			factor = 0.5f; 
		}else if(attacker instanceof Bunny) {
			factor = 5.0f;
		}
		return factor;
	}
